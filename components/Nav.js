...
export default function Nav() {
   ...
   async function logOut() {
    ...
    return (
        <aside className="fixed top-0 left-0 h-screen w-64 bg-black text-white pl-4 pt-4">
            <div className="flex flex-col items-start justify-between h-full w-full">
                ...
                <div className="pb-16 w-full pr-4">
                    <button 
                    onClick={logOut}
                    className="bg-red-600 text-white w-full rounded-md flex  justify-center items-center py-3 px-8 gap-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
